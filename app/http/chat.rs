...
const CHAT_TITLE_GENERATION_MAX_OUTPUT_TOKENS: u32 = 1024;
...
pub(crate) async fn edit_chat_user_message(
    ...
    let queued_run_json = json!({
        ...
        "latencyMode": prompt_context.latency_mode,
...
pub(crate) async fn queue_chat_message_internal(
    ...
    let requested_latency_mode = prompt_context.latency_mode;
    ...
    let chat_queued_run_json = json!({
        ...
        "latencyMode": requested_latency_mode,
