...
use foco_agent::{
    ContextPackItem, ToolResource, ToolResourceAccess, ToolResourceLock, build_available_tools_prompt,
    ...
    plan_tool_execution, tool_resource_locks_conflict,
};
...
use foco_tools::{
    CREATE_TODO_GRAPH_TOOL, EDIT_FILE_TOOL, RUN_COMMAND_TOOL, ToolCancellationToken, ToolExecution,
...
use crate::prompt::{
    ...
    configured_prompt_messages, environment_context_message, is_wsl_environment,
