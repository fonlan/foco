...
export const TRANSLATIONS: Record<AppLanguageId, Record<string, string>> = {
  en: {
    ...
    "Collapse task details": "Collapse task details",
    "({transport})": "({transport})",
  },
  "zh-CN": {
    "Unknown agent": "未知子代理",
    ...
    "View full record": "查看完整记录",
    "Show details": "展开详情",
    "Hide details": "收起详情",
    "Expand task details": "展开任务详情",
    "Collapse task details": "收起任务详情",
    ...
    "Loading remote workspace skills…": "正在加载远程工作区技能…",
    "Ask Foco anything…": "询问 Foco 任何问题…",
    "Loading more skills…": "正在加载更多技能…",
    ...
    "Locate running or failed plan": "定位正在执行或失败的计划",
    Locate: "定位",
    ...
    "Register an SSH workspace.": "注册 SSH 工作区。",
    Local: "本地",
    SSH: "SSH",
    "Remote Server": "远程服务器",
    "Select remote server": "选择远程服务器",
    "Remote path": "远程路径",
    ...
    "Skill list refresh failed: {error}": "技能列表刷新失败：{error}",
    Model: "模型",
    ...
    "Process tree termination requested": "已请求终止完整进程树",
    Rule: "规则",
    ...
    "Chat title generation": "会话标题生成",
    "Memory Dream planner": "记忆 Dream 规划",
    "Model availability test": "模型可用性测试",
    "Workspace Spec generation": "Workspace Spec 生成",
    "Workspace Spec update": "Workspace Spec 更新",
    ...
    "Stream diagnostic": "流诊断",
    "Diagnostic kind": "诊断类型",
    "Stream transport": "流传输方式",
    "Event type": "事件类型",
    "Previous event": "前一事件",
    "Provider code": "供应商错误码",
    "Provider message": "供应商错误信息",
    "Provider error type": "供应商错误类型",
    "Provider parameter": "供应商错误参数",
    "Frame bytes": "帧字节数",
    "Payload SHA-256": "载荷 SHA-256",
    "Payload truncated": "载荷已截断",
    "Payload excerpt": "载荷摘要",
    "Diagnostic JSON": "诊断 JSON",
    "Transport error": "传输错误",
    "Stored diagnostic bytes": "已存储诊断字节数",
    "Stored diagnostic SHA-256": "已存储诊断 SHA-256",
    "The diagnostic was compacted for audit storage.":
      "诊断已为审计存储压缩。",
    "HTTP method": "HTTP 方法",
    ...
    "New system prompt": "新建系统提示词",
    "New prompt": "新建提示词",
    "Create prompt": "创建提示词",
    "Create system prompt": "创建系统提示词",
    "Cancel new system prompt": "取消新建系统提示词",
    "Close new prompt dialog": "关闭新建提示词弹窗",
    "Delete prompt": "删除提示词",
    "Delete system prompt {name}": "删除系统提示词 {name}",
    "Delete system prompt?": "删除系统提示词？",
    "Cancel system prompt deletion": "取消删除系统提示词",
    "Confirm delete system prompt": "确认删除系统提示词",
    "Close delete prompt dialog": "关闭删除提示词弹窗",
    "This removes the prompt from your draft. Click Save to apply the change.":
      "这会从当前草稿中移除提示词。请点击保存以应用更改。",
    "Prompt name is required.": "请输入提示词名称。",
    "Prompt name is reserved.": "该名称为内置保留名称，不能使用。",
    "A prompt with this name already exists.": "已存在同名提示词。",
    "Choose the system prompt used for standard coding sessions. Changes apply after you save this page.":
      "选择标准编程会话使用的系统提示词。更改将在保存此页面后生效。",
    Custom: "自定义",
    "Prompt name": "提示词名称",
