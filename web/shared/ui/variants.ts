...
export const formField = tv({
  ...
  variants: {
    density: {
      compact: "[&_[data-slot=input]]:min-h-8 [&_[data-slot=input]]:rounded-[var(--foco-control-radius)] [&_[data-slot=input]]:border [&_[data-slot=input]]:border-border [&_[data-slot=input]]:bg-surface [&_[data-slot=textarea]]:min-h-8 [&_[data-slot=textarea]]:rounded-[var(--foco-control-radius)] [&_[data-slot=textarea]]:border [&_[data-slot=textarea]]:border-border [&_[data-slot=textarea]]:bg-surface [&_[data-slot=select-trigger]]:min-h-8 [&_[data-slot=select-trigger]]:rounded-[var(--foco-control-radius)] [&_[data-slot=select-trigger]]:border-border [&_[data-slot=select-trigger]]:bg-surface [&_[data-slot=select-trigger]]:shadow-none",
      comfortable: "[&_[data-slot=input]]:min-h-9 [&_[data-slot=input]]:rounded-[var(--foco-control-radius)] [&_[data-slot=input]]:border [&_[data-slot=input]]:border-border [&_[data-slot=input]]:bg-surface [&_[data-slot=textarea]]:min-h-9 [&_[data-slot=textarea]]:rounded-[var(--foco-control-radius)] [&_[data-slot=textarea]]:border [&_[data-slot=textarea]]:border-border [&_[data-slot=textarea]]:bg-surface [&_[data-slot=select-trigger]]:min-h-9 [&_[data-slot=select-trigger]]:rounded-[var(--foco-control-radius)] [&_[data-slot=select-trigger]]:border-border [&_[data-slot=select-trigger]]:bg-surface [&_[data-slot=select-trigger]]:shadow-none",
    },
  },
