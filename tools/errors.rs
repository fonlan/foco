...
use crate::{
    ...
    DEFAULT_AGENT_TOOL_TIMEOUT_MS, DEFAULT_FILE_TOOL_TIMEOUT_MS, DEFAULT_GRAPH_TOOL_TIMEOUT_MS,
    ...
    DEFAULT_WRITE_FILE_TIMEOUT_MS, EDIT_FILE_TOOL, FIND_FILES_TOOL, GET_PLANS_TOOL,
    ...
    MAX_TOOL_TIMEOUT_MS, READ_FILE_TOOL, READ_SPEC_TOOL, RUN_COMMAND_TOOL, SEARCH_TEXT_TOOL,
    SLEEP_TOOL, ToolOutputStream, UPDATE_PLAN_STEP_TOOL, UPDATE_PLAN_TOOL, UPDATE_SPEC_TOOL,
...
pub fn builtin_tool_timeout_ms(tool_name: &str, arguments: &Value) -> Result<u64, String> {
    let default_timeout_ms = match tool_name {
        ...
        CREATE_PLAN_TOOL | GET_PLANS_TOOL | UPDATE_PLAN_TOOL | UPDATE_PLAN_STEP_TOOL => {
