...
use crate::{
    ...
    AGENT_WAIT_TASKS_TOOL, APPLY_PATCH_TOOL, ASK_QUESTION_TOOL, CREATE_PLAN_TOOL,
    CREATE_TODO_GRAPH_TOOL, DEFAULT_AGENT_TOOL_TIMEOUT_MS, DEFAULT_APPLY_PATCH_TIMEOUT_MS,
    DEFAULT_FILE_TOOL_TIMEOUT_MS, DEFAULT_GET_COMMAND_OUTPUT_TIMEOUT_MS,
    DEFAULT_GRAPH_TOOL_TIMEOUT_MS, DEFAULT_IMAGE_GEN_TOOL_TIMEOUT_MS, DEFAULT_PLAN_TOOL_TIMEOUT_MS,
    DEFAULT_RUN_COMMAND_TIMEOUT_MS, DEFAULT_SEARCH_TEXT_TIMEOUT_MS, DEFAULT_SLEEP_TIMEOUT_MS,
    DEFAULT_SPEC_TOOL_TIMEOUT_MS, DEFAULT_TODO_GRAPH_TIMEOUT_MS, DEFAULT_WEB_TOOL_TIMEOUT_MS,
    DEFAULT_WRITE_FILE_TIMEOUT_MS, DELETE_PLAN_TOOL, EDIT_FILE_TOOL, FIND_FILES_TOOL,
    GET_COMMAND_OUTPUT_TOOL, GET_PLANS_TOOL, GET_TODO_GRAPH_TOOL, GRAPH_EXPLORE_TOOL,
    GRAPH_FIND_CALLEES_TOOL, GRAPH_FIND_CALLERS_TOOL, GRAPH_FIND_REFERENCES_TOOL,
    GRAPH_FIND_SYMBOLS_TOOL, GRAPH_RELATED_FILES_TOOL, IMAGE_GEN_TOOL, MAX_TOOL_TIMEOUT_MS,
    READ_FILE_TOOL, READ_SPEC_TOOL, RUN_COMMAND_TOOL, SEARCH_TEXT_TOOL, SLEEP_TOOL,
    STOP_COMMAND_TOOL, ToolOutputStream, UPDATE_PLAN_STEP_TOOL, UPDATE_PLAN_TOOL, UPDATE_SPEC_TOOL,
...
pub fn builtin_tool_timeout_ms(tool_name: &str, arguments: &Value) -> Result<u64, String> {
    let default_timeout_ms = match tool_name {
        ...
        IMAGE_GEN_TOOL => DEFAULT_IMAGE_GEN_TOOL_TIMEOUT_MS,
        WRITE_FILE_TOOL | EDIT_FILE_TOOL => DEFAULT_WRITE_FILE_TIMEOUT_MS,
        APPLY_PATCH_TOOL => DEFAULT_APPLY_PATCH_TIMEOUT_MS,
        ...
        | DELETE_PLAN_TOOL => DEFAULT_PLAN_TOOL_TIMEOUT_MS,
        READ_SPEC_TOOL | UPDATE_SPEC_TOOL => DEFAULT_SPEC_TOOL_TIMEOUT_MS,
        AGENT_LIST_TOOL
        | AGENT_GET_TASK_TOOL
        ...
        | AGENT_CREATE_INSTANCES_TOOL => DEFAULT_AGENT_TOOL_TIMEOUT_MS,
        ASK_QUESTION_TOOL => {
            return Err(
        ...
        GET_COMMAND_OUTPUT_TOOL | STOP_COMMAND_TOOL => DEFAULT_GET_COMMAND_OUTPUT_TIMEOUT_MS,
